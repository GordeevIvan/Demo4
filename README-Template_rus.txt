...
cd ./WpfApp6
dotnet ef dbcontext scaffold "server=localhost;user=root;password=1234;database=db10" "Pomelo.EntityFrameworkCore.MySql" --output-dir Models
----------------------------------------------------------------------------------------------------------
В APP.xaml
---------------------------------------------------------------------------------
 ...
 class ConstantData
    {
        ...
        public static MySql.Data.MySqlClient.MySqlConnection con = new MySql.Data.MySqlClient.MySqlConnection("server=172.17.4.11;user=root;pwd=2143;database=user_20is_6");
